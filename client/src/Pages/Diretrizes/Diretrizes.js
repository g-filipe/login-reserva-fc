...
const Diretrizes = () => {
  ...
  useEffect(() => {
    api.get(`/lotacao/${1}`).then((data) => {
      setCapacidade(data.data[0].capacidade);
      setVagas(data.data[0].vagas)
    });
  ...
  return (
    <div className="App">
      ...
      <div className="dir-spa-home">
        ...
        {openWarningModal && (
          <WarningModal closeWarningModal={setOpenWarningModal}>
            <div className="w-modal-text">
              <h1>
                Após confirmar, a porcentagem de ocupação das Unidades serão
                alteradas.
              </h1>
            ...
            <Link to="confirma-alt">
              <Button buttonSize="btn--p" buttonStyle="btn--solido">
                Sim
              </Button>
            </Link>
        ...
        <div className="dir-spa-home-right">
          ...
          <div className="dir-card">
            ...
            <div className="dir-table">
              <table className="table">
                ...
                <tr>
                  <td>São Paulo, SP</td>
                  <td>
                    <DropdownSP selected={selected} setSelected={setSelected} />
                  </td>
            ...
            <div className="dir-btn">
              ...
              <Button buttonStyle="btn--vazado" buttonSize="btn--m">
                {" "}
                Voltar{" "}
              </Button>
            </div>
